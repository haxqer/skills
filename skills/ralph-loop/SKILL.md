...
- Read [references/ralph-loop.md](references/ralph-loop.md) when you need Ralph rationale, Codex adaptation boundaries, durable-state guidance, or failure-mode handling.
